...
pub mod create_req {
    ...
    pub struct Options {
        ...
        pub mode: ::std::option::Option<options::Mode>,
    }
    pub mod options {
        #[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod update_req {
    ...
    pub struct Options {
        ...
        #[prost(string, tag = "2")]
        pub query: std::string::String,
        #[prost(oneof = "options::EmitOptions", tags = "3, 4")]
        pub emit_options: ::std::option::Option<options::EmitOptions>,
    }
    pub mod options {
        #[derive(Clone, PartialEq, ::prost::Oneof)]
...
pub struct StatisticsReq {
    #[prost(message, optional, tag = "1")]
    pub options: ::std::option::Option<statistics_req::Options>,
}
pub mod statistics_req {
    ...
    pub mod options {
        ...
        pub enum Mode {
            ...
            All(super::Empty),
            #[prost(message, tag = "3")]
            Transient(super::Empty),
            #[prost(message, tag = "4")]
            Continuous(super::Empty),
            #[prost(message, tag = "5")]
            OneTime(super::Empty),
        }
    }
...
pub struct StatisticsResp {
    #[prost(message, optional, tag = "1")]
    pub details: ::std::option::Option<statistics_resp::Details>,
}
pub mod statistics_resp {
    ...
    pub struct Details {
        ...
        pub epoch: i64,
        #[prost(string, tag = "4")]
        pub effective_name: std::string::String,
        #[prost(int32, tag = "5")]
        ...
        pub progress: f32,
        #[prost(string, tag = "14")]
        pub last_checkpoint: std::string::String,
        #[prost(int64, tag = "15")]
        pub events_processed_after_restart: i64,
        #[prost(string, tag = "16")]
        pub checkpoint_status: std::string::String,
        #[prost(int64, tag = "17")]
...
pub struct StateReq {
    #[prost(message, optional, tag = "1")]
    pub options: ::std::option::Option<state_req::Options>,
}
pub mod state_req {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Options {
...
pub struct StateResp {
    #[prost(message, optional, tag = "1")]
    pub state: ::std::option::Option<::prost_types::Value>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ResultReq {
    #[prost(message, optional, tag = "1")]
    pub options: ::std::option::Option<result_req::Options>,
}
pub mod result_req {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Options {
...
pub struct ResultResp {
    #[prost(message, optional, tag = "1")]
    pub result: ::std::option::Option<::prost_types::Value>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ResetReq {
    #[prost(message, optional, tag = "1")]
    pub options: ::std::option::Option<reset_req::Options>,
}
pub mod reset_req {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Options {
...
pub mod projections_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create(
            ...
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Create");
        ...
        pub async fn update(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Update");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn delete(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Delete");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<tonic::codec::Streaming<super::StatisticsResp>>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Statistics");
            self.inner
        ...
        pub async fn disable(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Disable");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn enable(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Enable");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn reset(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Reset");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn state(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/State");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn result(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/projections.Projections/Result");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
    impl<T: Clone> Clone for ProjectionsClient<T> {
        fn clone(&self) -> Self {
            Self {
