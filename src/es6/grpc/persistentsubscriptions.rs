        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/persistentsubscriptions.PersistentSubscriptions/Create",
            );
        ...
        pub async fn update(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/persistentsubscriptions.PersistentSubscriptions/Update",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn delete(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/persistentsubscriptions.PersistentSubscriptions/Delete",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn read(
        ...
        ) -> Result<tonic::Response<tonic::codec::Streaming<super::ReadResp>>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/persistentsubscriptions.PersistentSubscriptions/Read",
            );
            self.inner
